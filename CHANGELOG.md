...
### Added
- `OnDeviceVLMSDKDemo` Xcode project — pick a photo, choose a task (Caption / Ask / Tags / OCR),
...
### Added
- `OnDeviceVLMSDK` actor — on-device image understanding over MLX Swift VLMs.
